...
function function1($myValue, $selfCall, $idMaquina, $device_token)
{
    ...
    if ($selfCall == 0) {
        ...
        while ($rowMsg = mysqli_fetch_assoc($resultMsg)) {
            ...
            if ($fromMe == 'true' && $type == 'text') {
                echo '<div class="right" style="z-index: 1"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content" style="max-width: 600px; white-space: pre-line; word-wrap: break-word;"> <p class="mb-0 message-text"> ' . $message . ' </p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
            } else if ($fromMe == 'false' && $type == 'text') {
                echo '<div class="left" style="z-index: 1"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content" style="max-width: 600px; white-space: pre-line; word-wrap: break-word;"> <p class="mb-0 message-text"> ' . $message . ' </p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
            }

            // Image
            if ($fromMe == 'true' && $type == 'image') {
                echo '<div class="right"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content" style="max-width: 600px; white-space: pre-line; word-wrap: break-word;"> <p class="mb-0"><img src=' . $message . ' alt="Indisponivel" style="max-width: 500px; max-height: 400px;"></p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
                ...
                echo '<div class="left"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content" style="max-width: 600px; white-space: pre-line; word-wrap: break-word;"> <p class="mb-0"><img src=' . $message . ' alt="Indisponivel" style="max-width: 500px; max-height: 400px;"></p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
                if (strlen($caption) > 0 && $caption != 'null' && (!is_null($caption))) {
            ...
            // PDF ou MSWORD or DOC or DOCX or mp4
            // if ($fromMe == 'true' && ($type == 'pdf' || $type == 'msword' || $type == 'doc' || $type == 'docx' || $type == 'mp4')) {
            ...
            // } else if ($fromMe == 'false' && ($type == 'pdf' || $type == 'msword' || $type == 'doc' || $type == 'docx' || $type == 'mp4')) {
    ...
    if ($selfCall == 1) {
        ...
        while ($rowMsg = mysqli_fetch_assoc($resultMsg)) {
            ...
            // Text
            if ($fromMe == 'true' && $type == 'text') {
                echo '<div class="right"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content" style="max-width: 600px; white-space: pre-line; word-wrap: break-word;"> <p class="mb-0 message-text"> ' . $message . ' </p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
            } else if ($fromMe == 'false' && $type == 'text') {
                echo '<div class="left"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content" style="max-width: 600px; white-space: pre-line; word-wrap: break-word;"> <p class="mb-0 message-text"> ' . $message . ' </p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
            }
            ...
            if ($fromMe == 'true' && $type == 'image') {
                ...
                echo '<div class="left"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content"> <p class="mb-0"><img src=' . $message . ' alt="Indisponivel" style="max-width: 500px; max-height: 400px;"></p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
                if (strlen($caption) > 0 && $caption != 'null' && (!is_null($caption))) {
                    echo '<div class="left"> <div class="conversation-list"> <div class="user-chat-content"> <div class="ctext-wrap"> <div class="ctext-wrap-content" style="max-width: 600px; white-space: pre-line; word-wrap: break-word;"> <p class="mb-0 message-text"> ' . $caption . ' </p> <p class="chat-time mb-0"><i class="ri-time-line align-middle"></i> <span class="align-middle">' . $timeIn24HourFormat . '</span> </p> </div> </div> </div> </div> </div>';
                }
            }
