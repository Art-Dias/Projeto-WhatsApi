...
<!-- Mirrored from templates.hibootstrap.com/farol/saas-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Mar 2024 11:30:14 GMT -->
<head>
...
//<![CDATA[
window.__mirage2 = {petok:"E6OShBzfzyzOVqRNZ7yq5IBtP.uhC5gRDVyNGSDFiZg-1800-0.0.1.1"};
//]]>
</script>
...
<li class="menu-item mb-0">
<a href="saas-app.html" class="menu-link active">
SaaS App
</a>
</li>
</ul>
...
<img data-cfsrc="assets/images/united-states.jpg" class="rounded-circle wh-22" alt="united-states" style="display:none;visibility:hidden;"><noscript><img src="assets/images/united-states.jpg" class="rounded-circle wh-22" alt="united-states"></noscript>
</button>
...
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/united-states.jpg" class="wh-22 rounded-circle" alt="united-states" style="display:none;visibility:hidden;"><noscript><img src="assets/images/united-states.jpg" class="wh-22 rounded-circle" alt="united-states"></noscript>
</div>
...
<div class="d-flex align-items-center">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/spain.png" class="wh-22 rounded-circle" alt="spain" style="display:none;visibility:hidden;"><noscript><img src="assets/images/spain.png" class="wh-22 rounded-circle" alt="spain"></noscript>
</div>
<div class="flex-grow-1 ms-3">
<h4>Spain</h4>
</div>
...
<div class="d-flex align-items-center">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/germany.png" class="wh-22 rounded-circle" alt="germany" style="display:none;visibility:hidden;"><noscript><img src="assets/images/germany.png" class="wh-22 rounded-circle" alt="germany"></noscript>
</div>
<div class="flex-grow-1 ms-3">
<h4>Germany</h4>
</div>
...
<div class="d-flex align-items-center">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/notifications-1.jpg" alt="notifications" style="display:none;visibility:hidden;"><noscript><img src="assets/images/notifications-1.jpg" alt="notifications"></noscript>
</div>
<div class="flex-grow-1 ms-3">
...
<div class="d-flex align-items-center">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/notifications-2.jpg" alt="notifications" style="display:none;visibility:hidden;"><noscript><img src="assets/images/notifications-2.jpg" alt="notifications"></noscript>
</div>
<div class="flex-grow-1 ms-3">
...
<div>
<img data-cfsrc="assets/images/user-34.jpg" class="rounded-circle border wh-57 mb-4" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-34.jpg" class="rounded-circle border wh-57 mb-4" alt="user"></noscript>
...
<i class="ri-money-dollar-circle-line bg-primary twxt-white"></i>
<div class="text-end">
<h4 class="mb-1 body-font fs-24">$31,570</h4>
<span>Income Status</span>
</div>
</div>
<div class="d-flex justify-content-between mb-2">
<span class="fw-semibold">Income Target</span>
<span>$180548.00</span>
</div>
<div class="progress" role="progressbar" aria-label="Example 5px high" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 5px; background-color: #E9EFFC;">
...
<div class="card-body p-4">
<div class="d-flex justify-content-between align-items-center mb-4 pb-4">
<i class="ri-bar-chart-fill bg-primary twxt-white"></i>
<div class="text-end">
<h4 class="mb-1 body-font fs-24">40,178</h4>
<span>Total Orders</span>
</div>
</div>
<div class="d-flex justify-content-between mb-2">
<span class="fw-semibold">Order Target</span>
<span>30,40548.00 </span>
</div>
<div class="progress" role="progressbar" aria-label="Example 5px high" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 5px; background-color: #E9EFFC;">
<div class="progress-bar rounded-pill" style="width: 25%"></div>
</div>
...
<span class="d-block fw-bold text-dark fs-24 mt-2">1,452</span>
</div>
<div class="icons">
...
<p class="fs-14">
<span class="bg-success bg-opacity-10 px-2 py-1 fs-13 fw-semibold">4.87% <i class="ri-arrow-up-s-line"></i></span> Leads this month
</p>
</div>
</div>
</div>
...
<div class="d-flex justify-content-between mb-4">
<div>
<span class="fw-semibold">Overall Revenue</span>
<span class="d-block fw-bold text-dark fs-24 mt-2">$28,452</span>
</div>
<div class="icons">
...
<p class="fs-14">
<span class="bg-danger text-danger bg-opacity-10 px-2 py-1 fs-13 fw-semibold">0.50% <i class="ri-arrow-down-s-line"></i></span> Leads this month
</p>
</div>
</div>
</div>
...
<div class="d-flex justify-content-between mb-4">
<div>
<span class="fw-semibold">Average Price</span>
<span class="d-block fw-bold text-dark fs-24 mt-2">$200.5</span>
</div>
<div class="icons">
...
<p class="fs-14">
<span class="bg-success bg-opacity-10 px-2 py-1 fs-13 fw-semibold">2.22% <i class="ri-arrow-up-s-line"></i></span> Leads this month
</p>
</div>
</div>
</div>
...
<span class="d-block fw-bold text-dark fs-24 mt-2">7,805</span>
</div>
<div class="icons">
...
<p class="fs-14">
<span class="bg-danger text-danger bg-opacity-10 px-2 py-1 fs-13 fw-semibold">-1.21% <i class="ri-arrow-up-s-line"></i></span> Leads this month
</p>
</div>
</div>
</div>
...
<h4 class="fw-semibold fs-18 mb-sm-0">Revenue Summary</h4>
...
<div class="card-body p-4 pb-0 pb-xxl-4">
<div class="d-sm-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
<h4 class="fw-semibold fs-18 mb-sm-0">Sales Analytics</h4>
<div class="dropdown action-opt">
<button class="btn bg-transparent p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
<i data-feather="chevron-down"></i>
<span>Last Campaign Performance</span>
...
<div class="card-body p-4 pb-0 pb-xxl-4">
<div class="d-sm-flex justify-content-between align-items-center border-bottom pb-20 mb-20">
<h4 class="fw-semibold fs-18 mb-sm-0">Audience Overview</h4>
<div class="dropdown action-opt">
<button class="btn bg-transparent p-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
<i data-feather="chevron-down"></i>
<span>Last Campaign Performance</span>
...
<thead>
<tr>
<th scope="col" class="text-primary">Project Name</th>
...
<tr>
<td>
<a href="project-details.html" class="d-flex align-items-center mw-380">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/project-1.png" alt="project" style="display:none;visibility:hidden;"><noscript><img src="assets/images/project-1.png" alt="project"></noscript>
</div>
<div class="flex-grow-1 ms-3">
<h4 class="fw-semibold fs-16 mb-0 lh-base hover">Product UIUX Design </h4>
</div>
</a>
</td>
<td>
<div class="progress position-relative rounded-pill" role="progressbar" aria-label="Example with label" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
...
<li>
<img data-cfsrc="assets/images/user-30.jpg" class="border border-2 rounded-circle wh-25 bg-white border-color-white" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-30.jpg" class="border border-2 rounded-circle wh-25 bg-white border-color-white" alt="user"></noscript>
</li>
<li class="ms-8">
<img data-cfsrc="assets/images/user-31.jpg" class="border border-2 rounded-circle wh-25 bg-white border-color-white" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-31.jpg" class="border border-2 rounded-circle wh-25 bg-white border-color-white" alt="user"></noscript>
</li>
<li class="ms-8">
<img data-cfsrc="assets/images/user-32.jpg" class="border border-2 rounded-circle wh-25 bg-white border-color-white" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-32.jpg" class="border border-2 rounded-circle wh-25 bg-white border-color-white" alt="user"></noscript>
</li>
</ul>
</td>
<td>
<span class="d-block text-center">08 Mar 2024</span>
</td>
</tr>
<tr>
<td>
<a href="project-details.html" class="d-flex align-items-center mw-380">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/project-2.png" alt="project" style="display:none;visibility:hidden;"><noscript><img src="assets/images/project-2.png" alt="project"></noscript>
</div>
<div class="flex-grow-1 ms-3">
<h4 class="fw-semibold fs-16 mb-0 lh-base hover">Public Beta Release</h4>
</div>
</a>
</td>
<td>
<div class="progress position-relative rounded-pill" role="progressbar" aria-label="Example with label" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
...
<td>
<span class="d-block fs-15 text-center">$6,500</span>
</td>
<td>
<span class="badge bg-primary bg-opacity-10 text-primary py-2 px-3 fw-semibold text-center d-block">Complete</span>
</td>
<td>
<ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
<li>
...
<td>
<span class="d-block text-center">17 Apr 2024</span>
</td>
</tr>
<tr>
<td>
<a href="project-details.html" class="d-flex align-items-center mw-380">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/project-3.png" alt="project" style="display:none;visibility:hidden;"><noscript><img src="assets/images/project-3.png" alt="project"></noscript>
</div>
<div class="flex-grow-1 ms-3">
<h4 class="fw-semibold fs-16 mb-0 lh-base hover">Market And SEO</h4>
</div>
</a>
</td>
<td>
...
<td>
<span class="d-block fs-15 text-center">$12,000</span>
</td>
<td>
<span class="badge bg-primary bg-opacity-10 text-primary py-2 px-3 fw-semibold d-block text-center">Complete</span>
</td>
<td>
<ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
<li>
...
<td>
<span class="d-block text-center">10 Sep 2024</span>
</td>
</tr>
<tr>
<td>
<a href="project-details.html" class="d-flex align-items-center mw-380">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/project-4.png" alt="project" style="display:none;visibility:hidden;"><noscript><img src="assets/images/project-4.png" alt="project"></noscript>
</div>
<div class="flex-grow-1 ms-3">
<h4 class="fw-semibold fs-16 mb-0 lh-base hover">New Office Building</h4>
</div>
</a>
</td>
<td>
<div class="progress position-relative rounded-pill" role="progressbar" aria-label="Example with label" aria-valuenow="00" aria-valuemin="0" aria-valuemax="100">
<div class="progress-bar rounded-pill" style="width: 00%">
<span class="count">00%</span>
</div>
</div>
</td>
<td>
<span class="d-block fs-15 text-center">$9,000</span>
</td>
<td>
<span class="badge bg-danger bg-opacity-10 text-danger py-2 px-3 fw-semibold d-block text-center">Pending</span>
</td>
<td>
<ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
<li>
...
<td>
<span class="d-block text-center">06 Aug 2022</span>
</td>
</tr>
<tr>
<td>
<a href="project-details.html" class="d-flex align-items-center mw-380">
<div class="flex-shrink-0">
<img data-cfsrc="assets/images/project-5.png" alt="project" style="display:none;visibility:hidden;"><noscript><img src="assets/images/project-5.png" alt="project"></noscript>
</div>
<div class="flex-grow-1 ms-3">
<h4 class="fw-semibold fs-16 mb-0 lh-base hover">Product Devlopment</h4>
</div>
</a>
</td>
<td>
<div class="progress position-relative rounded-pill" role="progressbar" aria-label="Example with label" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">
<div class="progress-bar rounded-pill" style="width: 60%">
<span class="count">60%</span>
</div>
</div>
</td>
<td>
<span class="d-block fs-15 text-center">$14,500</span>
</td>
<td>
<span class="badge bg-success bg-opacity-10 text-success py-2 px-3 fw-semibold text-center d-block">Active</span>
</td>
<td>
<ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
<li>
...
<td>
<span class="d-block text-center">25 Jul 2024</span>
</td>
</tr>
</tbody>
</table>
...
<li class="page-item">
<a class="page-link icon" href="saas-app.html" aria-label="Previous">
<i data-feather="arrow-left"></i>
</a>
</li>
<li class="page-item"><a class="page-link active" href="saas-app.html">1</a></li>
...
<li class="page-item">
<a class="page-link icon" href="saas-app.html" aria-label="Next">
...
<img data-cfsrc="assets/images/user-20.jpg" class="rounded-3 border border-color-gray2" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-20.jpg" class="rounded-3 border border-color-gray2" alt="user"></noscript>
<div class="position-absolute p-1 bg-primary border border-2 border-white rounded-circle status-position"></div>
</div>
<div class="flex-grow-1 ms-3">
<p class="fs-16 fw-semibold mb-0 text-dark">Johen Mandel</p>
<p class="text-truncate d-inline-block">Hi, i want make enquiries about you work</p>
</div>
</div>
<p class="mt-3">
...
<div class="d-flex align-items-center">
<div class="flex-shrink-0 position-relative">
<img data-cfsrc="assets/images/user-21.jpg" class="rounded-3 border border-color-gray2" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-21.jpg" class="rounded-3 border border-color-gray2" alt="user"></noscript>
<div class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position"></div>
</div>
<div class="flex-grow-1 ms-3">
...
<div class="d-flex align-items-center">
<div class="flex-shrink-0 position-relative">
<img data-cfsrc="assets/images/user-22.jpg" class="rounded-3 border border-color-gray2" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-22.jpg" class="rounded-3 border border-color-gray2" alt="user"></noscript>
<div class="position-absolute p-1 bg-warning border border-2 border-white rounded-circle status-position"></div>
</div>
<div class="flex-grow-1 ms-3">
...
<div class="d-flex align-items-center">
<div class="flex-shrink-0 position-relative">
<img data-cfsrc="assets/images/user-23.jpg" class="rounded-3 border border-color-gray2" alt="user" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-23.jpg" class="rounded-3 border border-color-gray2" alt="user"></noscript>
<div class="position-absolute p-1 bg-danger border border-2 border-white rounded-circle status-position"></div>
</div>
<div class="flex-grow-1 ms-3">
...
<p class="fs-14">© <span class="text-primary">Farol</span> is Proudly Owned by <a href="https://hibootstrap.com/" target="_blank" class="text-decoration-none">HiBootstrap</a></p>
</footer>
...
<script src="assets/js/custom/sass-app.js"></script>
