...
<body>
            ...
            <ul class="menu-inner">
                ...
                <li class="menu-item open">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item">
                            <a href="project-create.html" class="menu-link active">
                                Project Create
                            </a>
                        </li>
                    </ul>
    ...
    <div class="container-fluid">
        <div class="main-content d-flex flex-column">
            ...
            <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
                <h3 class="mb-sm-0 mb-1 fs-18">Create Project1</h3>
                <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
                    ...
                    <li>
                        <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Create Project2</span>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <div class="card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <h3 class="fs-18 mb-4 border-bottom pb-20 mb-20">Create Project3</h3>
                            <form>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark ps-5 h-58" placeholder="EnvyTheme">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="date" class="form-control text-gray-light h-58">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <input type="text" class="form-control text-dark h-58 ps-5" placeholder="Enter rate">
                                                <i class="ri-briefcase-line position-absolute top-50 start-0 translate-middle-y fs-20 text-gray-light ps-20"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="form-group position-relative">
                                                <select class="form-select form-control text-gray-light h-58 ps-5" aria-label="Default select example">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-4 p-4 bg-border-gray-light d-sm-flex justify-content-between align-items-center rounded-10">
                                            <div class="d-sm-flex align-items-center mb-3 mb-sm-0 me-lg-3">
                                                ...
                                                <img data-cfsrc="assets/images/product-11.jpg" class="rounded-4 wh-78 ms-3 ms-lg-0" alt="product" style="display:none;visibility:hidden;"><noscript><img src="assets/images/product-11.jpg" class="rounded-4 wh-78 ms-3 ms-lg-0" alt="product"></noscript>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary py-3 px-5 fw-semibold text-white">Create Project4</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="col-lg-4">
                    <div class="card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <h3 class="fs-18 mb-4 border-bottom pb-20 mb-20">Priority Status</h3>
                            <form>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <ul class="ps-0 mb-0 list-unstyled">
                                        <li class="d-inline-block mb-2">
                                            <button class="btn bg-primary bg-opacity-10 text-primary fw-semibold fs-13">Design</button>
                                        </li>
                                        <li class="d-inline-block ms-2 mb-2">
                                            <button class="btn bg-primary bg-opacity-10 text-primary fw-semibold fs-13">UI UX Design</button>
                                        </li>
                                        <li class="d-inline-block ms-2 mb-2">
                                            <button class="btn bg-primary bg-opacity-10 text-primary fw-semibold fs-13">Development</button>
                                        </li>
                                        <li class="d-inline-block ms-2 mb-2">
                                            <button class="btn bg-primary bg-opacity-10 text-primary fw-semibold fs-13">App Develop</button>
                                        </li>
                                    </ul>
                                </div>
                            </form>
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <ul class="ps-0 mb-0 list-unstyled d-flex">
                                        <li>
                                            <img data-cfsrc="assets/images/user-7.jpg" class="wh-25 rounded-circle border border-2 border-color-white" alt="user" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Jordan Stevenson" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-7.jpg" class="wh-25 rounded-circle border border-2 border-color-white" alt="user" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Jordan Stevenson"></noscript>
                                        </li>
                                        <li class="ms-8">
                                            <img data-cfsrc="assets/images/user-8.jpg" class="wh-25 rounded-circle border border-2 border-color-white" alt="user" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Easin Arafat" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-8.jpg" class="wh-25 rounded-circle border border-2 border-color-white" alt="user" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Easin Arafat"></noscript>
                                        </li>
                                        <li class="ms-8">
                                            <img data-cfsrc="assets/images/user-9.jpg" class="wh-25 rounded-circle border border-2 border-color-white" alt="user" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Francis Frank" style="display:none;visibility:hidden;"><noscript><img src="assets/images/user-9.jpg" class="wh-25 rounded-circle border border-2 border-color-white" alt="user" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Francis Frank"></noscript>
                                        </li>
                                        <li class="ms-1">
                                            <a href="#" class="wh-25 rounded-circle bg-primary bg-opacity-10 text-primary text-decoration-none d-inline-block text-center position-relative">
                                                <span class="position-absolute top-50 start-50 translate-middle fs-20">+</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom p-4">
            <h5 class="offcanvas-title fs-18 mb-0" id="offcanvasRightLabel">Create User</h5>
        ...
        <div class="offcanvas-body p-4">
            <form>
                <div class="form-group mb-4">
                    ...
                    <input type="text" class="form-control text-dark" placeholder="Display Name">
                </div>
                <div class="form-group mb-4">
                    <label class="label">User Name</label>
                    <input type="text" class="form-control text-dark" placeholder="User Name">
                </div>
                <div class="form-group mb-4">
                    <label class="label">Email</label>
                    <input type="email" class="form-control text-dark" placeholder="Email">
                </div>
                <div class="form-group mb-4">
                ...
                <div class="form-group mb-4">
                    <label class="label">Total Project</label>
                    <input type="number" class="form-control text-dark" placeholder="Total Project">
                </div>
...
<!-- Mirrored from templates.hibootstrap.com/farol/project-create.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Mar 2024 11:30:54 GMT -->
