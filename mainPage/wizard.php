...
<head>
    ...
    <style>
        /* Adicione estilos personalizados para o Select2 */
...
<body>
                ...
                <div class="col-lg-12">
                    <div class="card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <h4 class="fs-18 mb-4">Cadastro Cliente</h4>
                                ...
                                <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab" tabindex="0">
                                    <div class="tab-content" id="myTabstepContent">
                                        <div class="tab-pane fade show active" id="step1-tab-pane" role="tabpanel" aria-labelledby="step1-tab" tabindex="0">
                                            ...
                                            <p class="text-gray-light mb-4">Preencha as informações abaixo</p>
                                            <form action="setarClienteParaAtendente.php" method="get">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group mb-4">
                                                            <label class="label">Nome</label>
                                                            <div class="form-group position-relative">
                                                                <input id="name" type="text" class="form-control text-dark ps-5 h-58" placeholder="Enter Name">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <div class="form-group position-relative">
                                                                ...
                                                                <!-- voltar aqui -->
                                                                <select id="atendente" class="form-select  ps-5 h-58 js-example-basic-single form-control" aria-label="Default select example" style="color: black;">
                                                                    <?php
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group mb-4">
                                                            <label class="label">Numero Telefone</label>
                                                            <div class="form-group position-relative">
                                                                <input type="number" class="form-control text-dark ps-5 h-58" id="number" name="number" pattern="[0-9\s]*" placeholder="11 991231234" required>
                                            ...
                                            <script>
                                                ...
                                                function cadastrar() {
                                                    var atendenteId = document.getElementById('atendente').value;
                                                    var nome = document.getElementById('name').value;
                                                    var numero = document.getElementById('number').value;

                                                    console.log(`${atendenteId}, ${nome}, ${numero}`);

                                                    //Fazer AJAX request para cadastrar cliente ao atendente

                                                    var formData = new FormData();
                                                    formData.append('atendente', atendenteId);
                                                    ...
                                                    xhttp.onreadystatechange = function() {
                                                        if (this.readyState == 4 && this.status == 200) {
                                                            ...
                                                            // window.confirm('Aoba, olhaa carinha dele');
                                                        }
                                                    };

                                                    // Change the request method to POST and send the FormData
                                                    xhttp.open("POST", "setarClienteParaAtendente.php", true);
                                                    xhttp.send(formData);
                                                };
                                            </script>
                                        </div>
    ...
    <script src="assets/js/select-jquery-3.6.4.min.js"></script>
    <script src="assets/js/select2.min.js"></script>
    <script>
        $(document).ready(function() {
            // Selecione o elemento e chame o método select2()
