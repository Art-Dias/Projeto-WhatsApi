                ...
                <div class="col-lg-12">
                    <div class="card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <h4 class="fs-18 mb-4">Selecionar Atendente</h4>
                                ...
                                <div class="tab-pane fade show active" id="preview-tab-pane" role="tabpanel" aria-labelledby="preview-tab" tabindex="0">
                                    <div class="tab-content" id="myTabstepContent">
                                        <div class="tab-pane fade show active" id="step1-tab-pane" role="tabpanel" aria-labelledby="step1-tab" tabindex="0">
                                            <!-- <h4 class="fs-18 fw-semibold">Selecione o Atendente</h4> -->
                                            ...
                                            <form action="../index.php" method="post">
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-4">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <select name="atendente" id="atendente" class="form-select form-control ps-5 h-58" aria-label="Default select example" style="color: black;">
                                                                <?php
                                                                ...
                                                                try {
                                                                    ...
                                                                    $sqlAtendentes = "SELECT * FROM `atendentes_$device_token` ORDER BY id ASC";

                                                                    $resultSql = mysqli_query($conn, $sqlAtendentes);
                                                                    while ($row = mysqli_fetch_assoc($resultSql)) {
                                                                        $getName = $row['nome'];
                                                                        $getId = $row['id'];
                                                                        echo "<option value=\"$getId, $getName\">$getName</option>";
                                                                    }
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-group d-flex gap-3">
                                                        <button type="submit" class="btn btn-primary py-3 px-5 fw-semibold text-white">Selecionar</button>
                                                    </div>
                                                </div>
                                        </div>
                                        </form>
